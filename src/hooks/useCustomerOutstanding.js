...
export async function fetchCustomerOutstanding(customerId) {  
    try { 
        const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/customerTransaction/pending/${customerId}`);
...
export function useCustomerOutstanding(customerId) {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            try {
                const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/customerTransaction/pending/${customerId}`);
