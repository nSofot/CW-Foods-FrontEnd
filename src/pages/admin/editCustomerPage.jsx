...
export default function EditCustomerPage() {
	...
	if (location.state) {
        ...
        setCreditPeriod(data.creditPeriod || 0);
	...
	async function updateCustomer() {
		...
		try {
			...
			await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/customer/${customerId}`, updatedCustomer, {
	...
	return (
		...
		<div className="w-full h-full flex flex-col p-4">
			<div className="flex justify-between items-center mb-4">
				<div>
					<h1 className="text-xl font-semibold text-gray-800">✏️ Edit Customer</h1>
					<p className="text-sm text-gray-500">Update existing customer information</p>
				</div>
				{/* Update Button */}
