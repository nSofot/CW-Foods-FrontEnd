            ...
            <div className="flex-1 overflow-y-auto space-y-2 pr-2">
              ...
              {openTransactions && (
                <div className="ml-4 flex flex-col space-y-1">
                  ...
                  <Link className={getClass("supplier-payment")} to="/admin/supplier-payment">Supplier Payment</Link>
                  <Link className={getClass("payment-receipt")} to="/admin/stock-adjustment">Stock Adjustment</Link>
